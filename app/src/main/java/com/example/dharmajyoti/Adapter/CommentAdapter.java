...
import com.example.dharmajyoti.Model.Comment;
...
public class CommentAdapter extends RecyclerView.Adapter<CommentAdapter.ViewHolder>
{
    ...
    private void getUserInfo(final ImageView image, final TextView username, String publisherid)
    {
        ...
        if(fUser.getUid().equals("gBzy3ODCN6Ur94FagG9vSM2EDBB3"))
        {
            DatabaseReference ref= FirebaseDatabase.getInstance().getReference().child("Admin").child(publisherid);
